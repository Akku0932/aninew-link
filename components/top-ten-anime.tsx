  ...
  if (isLoading) {
    return (
      <div className="p-4 md:p-6 rounded-xl bg-gradient-to-r from-gray-100/50 via-gray-200/30 to-gray-100/50 dark:from-gray-900/50 dark:via-gray-800/30 dark:to-gray-900/50 backdrop-blur-sm transition-colors duration-300">
        <div className="mb-2 h-8 w-40 animate-pulse rounded bg-gray-300 dark:bg-gray-800"></div>
        <div className="space-y-2">
          {[...Array(10)].map((_, i) => (
            <div key={i} className="flex h-16 animate-pulse gap-2 rounded-lg bg-gray-300 dark:bg-gray-800"></div>
          ))}
        </div>
      </div>
    )
  ...
  return (
    <div className="p-4 md:p-6 h-full rounded-xl bg-gradient-to-r from-gray-100/50 via-gray-200/30 to-gray-100/50 dark:from-gray-900/50 dark:via-gray-800/30 dark:to-gray-900/50 backdrop-blur-sm transition-colors duration-300">
      ...
      <Tabs defaultValue="today" value={period} onValueChange={setPeriod} className="h-full">
        <TabsList className="mb-4 bg-gray-100 dark:bg-gray-900 w-full justify-between transition-colors duration-300">
        ...
        {["today", "week", "month"].map((periodKey) => (
          ...
          >
            ...
            <div className="mt-4 flex justify-center">
              <button className="rounded-full bg-gray-200 dark:bg-gray-800 px-4 py-2 text-xs font-medium text-gray-800 dark:text-white transition-colors hover:bg-gray-300 dark:hover:bg-gray-700">
                View All Rankings
              </button>
            </div>
          </TabsContent>
